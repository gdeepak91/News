...
const Technology = () => {
  ...
  const getNews = async () =>{
    const response = await fetch('https://newsapi.org/v2/top-headlines?country=in&category=technology&apiKey=9b496050f845467abf94ae79f016212c');
  ...
  return (
    <>
      <div className='mt-5'>
        <p className='h1 text-center'>Technology News</p>
      </div>
