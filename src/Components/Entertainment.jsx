...
const Entertainment = () => {
  ...
  const getNews = async () =>{
    const response = await fetch('https://newsapi.org/v2/top-headlines?country=in&category=entertainment&apiKey=9b496050f845467abf94ae79f016212c');
  ...
  return (
    <>
      <div className='mt-5'>
        <p className='h1 text-center'>Entertainment News</p>
      </div>
